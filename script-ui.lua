...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        ToggleRegion.InputBegan:Connect(function(Input)
            if ((Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch) or Input.UserInputType == Enum.UserInputType.Touch) and not Library:MouseIsOverOpenedFrame() then
...
function Library:CreateWindow(...)
    ...
    local HideUI = Library:Create('TextButton', {
        BackgroundTransparency = 1;
        TextColor3 = Color3.new(255,255,255);
        Position = UDim2.new(0, 500, 0, 0);
        Size = UDim2.new(0, 39, 0, 25);
        Visible = true;
        Text = 'Hide';
        Modal = false;
        Parent = Inner;
    ...
    HideUI.MouseButton1Down:connect(function()
        if(Outer.Size.Y.Offset == 40) then
            HideUI.Text = "Hide"
            Outer.Size = Config.Size
            MainSectionInner.Visible = true;
        else
            HideUI.Text = "Show"
            Outer.Size = UDim2.fromOffset(Config.Size.X.Offset, 40)
            MainSectionInner.Visible = false;
        end
    end)
